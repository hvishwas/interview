...
class Server<K extends Cache> {
    ...
    private HashFunction<String> hashFunction;

    public Server(String serverId, HashFunction<String> hashFunction) {
...
public class DistributedCaching {
    ...
    public static void main(String[] args) {
        DistributedCachingImp<Server<Cache>, Cache> distributedCachingImp = new DistributedCachingImp<>(2);
